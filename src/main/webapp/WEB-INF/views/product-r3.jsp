                            ...
                            <div class="product-details-img-content">
                                <div class="product-details-tab mr-40">
                                    <div class="product-details-large tab-content">
                                        <div class="tab-pane active" id="pro-details1">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r3-bl1.png">
                                                    <img src="assets/img/product-details/r3-l1.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details2">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r3-bl2.png">
                                                    <img src="assets/img/product-details/r3-l2.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                                        <a class="active product-link" data-product-id="30" href="#pro-details1">
                                            <img src="assets/img/product-details/r3-s1.png" alt="product 1">
                                        </a>
                                        <a href="#pro-details2" data-product-id="31" class="product-link">
                                            <img src="assets/img/product-details/r3-s2.png" alt="product 2">
                                        </a>
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content">
                                ...
                                <div class="product-overview">
                                    ...
                                    <p>The Yamaha R3 <span id="product-description">
                                            <?= htmlspecialchars($row1['description']); ?>
                                        </span> is a high-performance sports bike that blends sleek design with
                                        exceptional power, making it a perfect choice for aspiring riders and seasoned
                                        enthusiasts. Powered by a 321cc twin-cylinder engine, it delivers smooth
                                        acceleration, superb handling, and a thrilling ride on both city roads and
                                        highways.
                                        With its aggressive styling, advanced features like LED headlights, digital
                                        instrumentation, and lightweight chassis, the R3 offers an unparalleled riding
                                        experience for those who seek the ultimate in sports bike performance.</p>
                                </div>
