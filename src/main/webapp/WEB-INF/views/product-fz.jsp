                            ...
                            <div class="product-details-img-content">
                                <div class="product-details-tab mr-40">
                                    <div class="product-details-large tab-content">
                                        <div class="tab-pane active" id="pro-details1">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/fz-bl1.png">
                                                    <img src="assets/img/product-details/fz-l1.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details2">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/fz-bl2.png">
                                                    <img src="assets/img/product-details/fz-l2.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                                        <a class="active product-link" data-product-id="3" href="#pro-details1">
                                            <img src="assets/img/product-details/fz-s1.png" alt="product 1">
                                        </a>
                                        <a href="#pro-details2" data-product-id="4" class="product-link">
                                            <img src="assets/img/product-details/fz-s2.png" alt="product 2">
                                        </a>
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content">
                                ...
                                <div class="product-overview">
                                    ...
                                    <p>The Yamaha FZ <span id="product-description">
                                            <?= htmlspecialchars($row1['description']); ?>
                                        </span> is a stylish and powerful street bike designed for urban riders who
                                        crave performance and agility. Equipped with a 149cc engine, it delivers smooth
                                        power, excellent fuel efficiency, and superior handling. With its bold design,
                                        LED
                                        lighting, and advanced features, the FZ offers a thrilling ride and unmatched
                                        comfort on every journey.</p>
                                </div>
