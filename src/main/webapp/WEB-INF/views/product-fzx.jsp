                            ...
                            <div class="product-details-img-content">
                                <div class="product-details-tab mr-40">
                                    <div class="product-details-large tab-content">
                                        <div class="tab-pane active" id="pro-details1">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/fzx-bl1.png">
                                                    <img src="assets/img/product-details/fzx-l1.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details2">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/fzx-bl2.png">
                                                    <img src="assets/img/product-details/fzx-l2.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details3">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/fzx-bl3.png">
                                                    <img src="assets/img/product-details/fzx-l3.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details4">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/fzx-bl4.png">
                                                    <img src="assets/img/product-details/fzx-l4.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                                        <a class="active product-link" data-product-id="17" href="#pro-details1">
                                            <img src="assets/img/product-details/fzx-s1.png" alt="product 1">
                                        </a>
                                        <a href="#pro-details2" data-product-id="18" class="product-link">
                                            <img src="assets/img/product-details/fzx-s2.png" alt="product 2">
                                        </a>
                                        <a href="#pro-details3" data-product-id="19" class="product-link">
                                            <img src="assets/img/product-details/fzx-s3.png" alt="">
                                        </a>
                                        <a href="#pro-details4" data-product-id="20" class="product-link">
                                            <img src="assets/img/product-details/fzx-s4.png" alt="">
                                        </a>
                                        <!--<a href="#pro-details5">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content">
                                ...
                                <div class="product-overview">
                                    ...
                                    <p>The Yamaha FZ-X <span id="product-description">
                                            <?= htmlspecialchars($row1['description']); ?>
                                        </span> blends retro styling with modern performance, making it the perfect
                                        choice for riders who crave a unique, adventurous ride. Powered by a 149cc
                                        engine
                                        with a fuel-injected system, it offers smooth power delivery, excellent fuel
                                        efficiency, and precise handling. With features like LED lighting, a digital
                                        instrument cluster, and a comfortable upright riding position, the FZ-X is built
                                        for
                                        both city commutes and long-distance explorations.</p>
                                </div>
