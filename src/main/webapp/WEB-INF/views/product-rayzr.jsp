                            ...
                            <div class="product-details-img-content">
                                <div class="product-details-tab mr-40">
                                    <div class="product-details-large tab-content">
                                        <div class="tab-pane active" id="pro-details1">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/rayzr-bl1.png">
                                                    <img src="assets/img/product-details/rayzr-l1.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details2">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/rayzr-bl2.png">
                                                    <img src="assets/img/product-details/rayzr-l2.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details3">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/rayzr-bl3.png">
                                                    <img src="assets/img/product-details/rayzr-l3.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- <div class="tab-pane" id="pro-details3">
                                    ...
                                    <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                                        <a class="active product-link" data-product-id="40" href="#pro-details1">
                                            <img src="assets/img/product-details/rayzr-s1.png" alt="product 1">
                                        </a>
                                        <a href="#pro-details2" data-product-id="41" class="product-link">
                                            <img src="assets/img/product-details/rayzr-s2.png" alt="product 2">
                                        </a>
                                        <a href="#pro-details3" data-product-id="42" class="product-link">
                                            <img src="assets/img/product-details/rayzr-s3.png" alt="">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content">
                                ...
                                <div class="product-overview">
                                    ...
                                    <p>The Yamaha RayZR <span id="product-description">
                                            <?= htmlspecialchars($row1['description']); ?>
                                        </span> is a sleek and stylish scooter designed for urban commuters who
                                        value performance, efficiency, and cutting-edge design. Powered by a 113cc
                                        engine,
                                        it delivers quick acceleration and excellent fuel efficiency, making it perfect
                                        for
                                        city riding. With its aggressive design, modern features like LED lighting,
                                        digital
                                        display, and lightweight chassis, the RayZR offers a smooth, comfortable ride
                                        and
                                        stands out as a top choice for riders seeking both style and functionality.</p>
                                </div>
