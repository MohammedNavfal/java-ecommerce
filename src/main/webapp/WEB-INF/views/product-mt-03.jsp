                            ...
                            <div class="product-details-img-content">
                                <div class="product-details-tab mr-40">
                                    <div class="product-details-large tab-content">
                                        <div class="tab-pane active" id="pro-details1">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/mt03-bl1.png">
                                                    <img src="assets/img/product-details/mt03-l1.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details2">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/mt03-bl2.png">
                                                    <img src="assets/img/product-details/mt03-l2.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                                        <a class="active product-link" data-product-id="21" href="#pro-details1">
                                            <img src="assets/img/product-details/mt03-s1.png" alt="product 1">
                                        </a>
                                        <a href="#pro-details2" data-product-id="22" class="product-link">
                                            <img src="assets/img/product-details/mt03-s2.png" alt="product 2">
                                        </a>
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content">
                                ...
                                <div class="product-overview">
                                    ...
                                    <p>The Yamaha MT-03 <span id="product-description">
                                            <?= htmlspecialchars($row1['description']); ?>
                                        </span> is a dynamic naked street bike designed for riders who crave
                                        thrilling performance and aggressive styling. Powered by a 321cc twin-cylinder
                                        engine, it delivers exceptional power, agility, and smooth handling, making it
                                        perfect for both city streets and winding roads. With its sharp design, advanced
                                        features like LED lighting and digital display, and lightweight chassis, the
                                        MT-03
                                        offers an exhilarating riding experience for enthusiasts who want to dominate
                                        the
                                        streets.</p>
                                </div>
