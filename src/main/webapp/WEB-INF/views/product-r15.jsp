                            ...
                            <div class="product-details-img-content">
                                <div class="product-details-tab mr-40">
                                    <div class="product-details-large tab-content">
                                        <div class="tab-pane active" id="pro-details1">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r15-bl1.png">
                                                    <img src="assets/img/product-details/r15-l1.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details2">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r15-bl2.png">
                                                    <img src="assets/img/product-details/r15-l2.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details3">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r15-bl3.png">
                                                    <img src="assets/img/product-details/r15-l3.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details4">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r15-bl4.png">
                                                    <img src="assets/img/product-details/r15-l4.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="pro-details5">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r15-bl5.png">
                                                    <img src="assets/img/product-details/r15-l5.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <!--<div class="tab-pane" id="pro-details5">
                                    ...
                                    <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                                        <a class="active product-link" data-product-id="32" href="#pro-details1">
                                            <img src="assets/img/product-details/r15-s1.png" alt="product 1">
                                        </a>
                                        <a href="#pro-details2" data-product-id="33" class="product-link">
                                            <img src="assets/img/product-details/r15-s2.png" alt="product 2">
                                        </a>
                                        <a href="#pro-details3" data-product-id="34" class="product-link">
                                            <img src="assets/img/product-details/r15-s3.png" alt="">
                                        </a>
                                        <a href="#pro-details4" data-product-id="35" class="product-link">
                                            <img src="assets/img/product-details/r15-s4.png" alt="">
                                        </a>
                                        <a href="#pro-details5" data-product-id="36" class="product-link">
                                            <img src="assets/img/product-details/r15-s5.png" alt="">
                                        </a>
                                        <!--<a href="#pro-details5">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content">
                                ...
                                <div class="product-overview">
                                    ...
                                    <p>The Yamaha R15 <span id="product-description">
                                            <?= htmlspecialchars($row1['description']); ?>
                                        </span> is a true performance machine, designed for riders who seek the thrill
                                        of track-inspired performance in a street-legal package. Powered by a 155cc VVA
                                        (Variable Valve Actuation) engine, it offers exceptional power, rapid
                                        acceleration,
                                        and precise handling, making it ideal for both city commuting and spirited
                                        rides.
                                        With its aggressive design, aerodynamic fairing, LED lighting, and advanced
                                        features
                                        like a digital instrument cluster and dual-channel ABS, the R15 delivers an
                                        exhilarating riding experience every time.</p>
                                </div>
            ...
            document.querySelectorAll('.product-link').forEach(item => {
                item.addEventListener('click', function (event) {
                    ...
                    if (productId == "32") {
                        ...
                        form.setAttribute('data-product-id', '<?= htmlspecialchars($row3['id']); ?>');
                        form.setAttribute('data-product-name', '<?= htmlspecialchars($row3['name']); ?>');
                        form.setAttribute('data-product-price', '<?= htmlspecialchars($row3['price']); ?>');

                        // Change content for row3 (again, this is a static example; in real life, it can be fetched dynamically)
                        document.getElementById('product-name').innerText = "<?= htmlspecialchars($row3['name']); ?>"; // Example static change
                        document.getElementById('product-price').innerText = "<?= htmlspecialchars($row3['price']); ?>";
                        document.getElementById('product-description').innerText = "<?= htmlspecialchars($row3['description']); ?>"; // Example static change

                    } else if (productId == "35") {
                        form.setAttribute('data-product-id', '<?= htmlspecialchars($row4['id']); ?>');
                        form.setAttribute('data-product-name', '<?= htmlspecialchars($row4['name']); ?>');
                        form.setAttribute('data-product-price', '<?= htmlspecialchars($row4['price']); ?>');

                        // Change content for row3 (again, this is a static example; in real life, it can be fetched dynamically)
                        document.getElementById('product-name').innerText = "<?= htmlspecialchars($row4['name']); ?>"; // Example static change
                        document.getElementById('product-price').innerText = "<?= htmlspecialchars($row4['price']); ?>";
                        document.getElementById('product-description').innerText = "<?= htmlspecialchars($row4['description']); ?>"; // Example static change

                    } else if (productId == "36") {
                        form.setAttribute('data-product-id', '<?= htmlspecialchars($row5['id']); ?>');
                        form.setAttribute('data-product-name', '<?= htmlspecialchars($row5['name']); ?>');
                        form.setAttribute('data-product-price', '<?= htmlspecialchars($row5['price']); ?>');

                        // Change content for row3 (again, this is a static example; in real life, it can be fetched dynamically)
                        document.getElementById('product-name').innerText = "<?= htmlspecialchars($row5['name']); ?>"; // Example static change
                        document.getElementById('product-price').innerText = "<?= htmlspecialchars($row5['price']); ?>";
                        document.getElementById('product-description').innerText = "<?= htmlspecialchars($row5['description']); ?>"; // Example static change
