                                ...
                                <div class="product-details-tab mr-40">
                                    <div class="product-details-large tab-content">
                                        <div class="tab-pane active" id="pro-details1">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="assets/img/product-details/r15m-bl1.png">
                                                    <img src="assets/img/product-details/r15m-l1.png" alt="">
                                                </a>
                                            </div>
                                        </div>
                                   ...
                                   <div class="tab-pane" id="pro-details3">
                                    ...
                                    <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                                        <a class="active product-link" data-product-id="37" href="#pro-details1">
                                            <img src="assets/img/product-details/r15m-s1.png" alt="product 1">
                                        </a>
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-content">
                                ...
                                <div class="product-overview">
                                    ...
                                    <p>The Yamaha R15M <span id="product-description">
                                            <?= htmlspecialchars($row1['description']); ?>
                                        </span> is the ultimate sportbike for enthusiasts, combining cutting-edge
                                        technology, aggressive design, and track-ready performance. Powered by a 155cc
                                        VVA
                                        engine, it offers superior power delivery and precision handling, enhanced by
                                        features like a quick-shifter, dual-channel ABS, and a sophisticated digital
                                        display. With a premium finish, aerodynamic styling, and MotoGP-inspired
                                        elements,
                                        the R15M delivers an unmatched riding experience, whether on the street or the
                                        track.</p>
                                </div>
